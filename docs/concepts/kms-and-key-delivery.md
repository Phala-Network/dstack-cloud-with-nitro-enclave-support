...
For details on governance, see [On-chain Governance Model](governance.md).
...
- **[Run a dstack-kms CVM on GCP](../how-to/run-dstack-kms-on-gcp.md)** — Deploy KMS on GCP
- **[Deploy On-chain KMS Smart Contracts](../how-to/deploy-onchain-kms.md)** — Set up on-chain authorization
