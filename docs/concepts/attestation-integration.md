...
For the registration process, see [Register Workload Measurements](../how-to/register-enclave-measurement.md).
...
- **[Register Workload Measurements](../how-to/register-enclave-measurement.md)** — How to register measurements on-chain
- **[Runbook](../operations/runbook.md)** — Troubleshooting attestation failures
