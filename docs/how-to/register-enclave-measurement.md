...
|-------------------|---------------------|---------|---------------|
| **KMS Registration** | KMS's `mrAggregated` (GCP) or public key | Proves KMS runs in a genuine TEE | [Run dstack-kms on GCP](run-dstack-kms-on-gcp.md) Step 8 |
...
![Measurement Registration Flow](../images/measurement-registration-flow.png)
...
- **[Manage Governance](manage-governance.md)** — Other governance operations
- **[Concept: Attestation Integration](../concepts/attestation-integration.md)** — How measurements are generated
- **[Concept: KMS and Key Delivery](../concepts/kms-and-key-delivery.md)** — How KMS uses measurements
