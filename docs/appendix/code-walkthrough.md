...
![Key Request Flow](../images/key-request-flow.png)
...
![CVM Deployment Flow](../images/cvm-deployment-flow.png)
...
1. **Understand the architecture** — Read [concepts/overview.md](../concepts/overview.md) first
