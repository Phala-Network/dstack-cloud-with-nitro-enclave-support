...
| Cause | Fix |
|-------|-----|
| Measurement not registered on-chain | Register the measurement via governance. See [Register Workload Measurements](../how-to/register-enclave-measurement.md). |
...
| KMS bootstrap not completed | Complete the bootstrap procedure. See [Run a dstack-kms CVM on GCP](../how-to/run-dstack-kms-on-gcp.md). |
...
- **[Monitoring and Alerting](monitoring-alerting.md)** — Set up proactive monitoring
- **[Upgrade Procedures](upgrade.md)** — Upgrade versions to fix known issues
