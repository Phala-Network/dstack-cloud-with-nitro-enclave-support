...
5. **Re-bootstrap if the KMS image changed:**
   ...
   - Follow the bootstrap procedure in [Run a dstack-kms CVM on GCP](../how-to/run-dstack-kms-on-gcp.md)
...
3. **Register new measurements on-chain:**
   - See [Register Workload Measurements](../how-to/register-enclave-measurement.md)
...
- **[Monitoring and Alerting](monitoring-alerting.md)** — Monitor upgrade impact
- **[Runbook](runbook.md)** — Troubleshoot upgrade issues
