...
| Term | Definition |
|------|-----------|
| **dstack SDK** | The open-source confidential computing framework. Provides libraries (Python, TypeScript, Rust, Go) for attestation, key retrieval, and storage encryption. [GitHub](https://github.com/Dstack-TEE/dstack) |
| **dstack-cloud** | An extension of dstack SDK that enables deployment on GCP Confidential VMs and AWS Nitro Enclaves. Provides the `dstack-cloud` CLI. [GitHub](https://github.com/Phala-Network/dstack-cloud) |
